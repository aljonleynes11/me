(function () {
  ...
  Alpine.data("rsvp", () => ({
    ...
    canSubmit() {
      ...
      const companion1Valid = !hasCompanion || hasCompanionBeverage;
    ...
    async submit() {
      ...
      const payload = {
        ...
        companion: this.capitalize(this.companion) || null,
        companionBeverage:
          ((this.capitalize(this.companion) || "").trim().length >= 3 &&
            this.capitalize(this.companionBeverage)) ||
          null,
        companion2:
          ...
          .then((data) => {
            try {
              ...
              const toStore = {
                ...
                companion: (this.companion || "").trim() || null,
                companionBeverage:
